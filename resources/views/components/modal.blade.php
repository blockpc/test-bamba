<div 
    ...
    class="fixed flex items-center justify-center overflow-auto z-50 bg-black bg-opacity-70 left-0 right-0 top-0 bottom-0"  
    ...
    <!-- Modal -->
    <div x-show="show"
        {{ $attributes->merge(['class' => 'bg-white text-gray-800 dark:bg-gray-800 dark:text-gray-200 rounded-xl shadow-2xl p-3 w-full sm:w-96 mx-2 md:p-6 md:mx-5 max-h-screen overflow-y-auto scrollbar-thin scrollbar-thumb-gray-600']) }} 
